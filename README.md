...
- A live deployed URL and GitHub repository URL are not generated by the codebase itself; they should be added when the repository is pushed and deployed.
